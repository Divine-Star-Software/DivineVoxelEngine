...
namespace DBO
{
    ...
    public:
        ...
        Binary::DataView *view;

        DBOBuilder(Binary::DataView *externalView) : view(externalView)
        {
        }
    ...
    DBONode *BufferToDBO::create(Binary::DataView *view)
    {
        ...
        while (builder->index() < length)
        {
            ...
            builder->increment(Binary::ByteCounts_UInt8);
    ...
    BufferToDBO::BufferToDBO()
    {
        ...
        typedArrayMap[DBOMarkers_Int8] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length; i += Binary::ByteCounts_Int8)
            {
                array->push_back(builder->view->getInt8(i));
            }
            builder->increment(Binary::ByteCounts_Int8 * length);
            return node;
        };
        typedArrayMap[DBOMarkers_UInt8] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length; i += Binary::ByteCounts_UInt8)
            {
                array->push_back(builder->view->getUint8(i));
            }

            builder->increment(Binary::ByteCounts_UInt8 * length);
            return node;
        };
        typedArrayMap[DBOMarkers_Int16] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length * Binary::ByteCounts_Int16; i += Binary::ByteCounts_Int16)
            {
                array->push_back(builder->view->getInt16(i));
            }
            builder->increment(Binary::ByteCounts_Int16 * length);
            return node;
        };
        typedArrayMap[DBOMarkers_UInt16] = [](DBOBuilder *builder, int32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length * Binary::ByteCounts_UInt16; i += Binary::ByteCounts_UInt16)
            {
                array->push_back(builder->view->getInt16(i));
            }
            builder->increment(Binary::ByteCounts_UInt16 * length);
            return node;
        };
        ...
        typedArrayMap[DBOMarkers_Int32] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length * Binary::ByteCounts_Int32; i += Binary::ByteCounts_Int32)
            {
                array->push_back(builder->view->getInt32(i));
            }
            builder->increment(Binary::ByteCounts_Int32 * length);
            return node;
        };
        typedArrayMap[DBOMarkers_UInt32] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length * Binary::ByteCounts_UInt32; i += Binary::ByteCounts_UInt32)
            {
                array->push_back(builder->view->getInt32(i));
            }
            builder->increment(Binary::ByteCounts_UInt32 * length);
            return node;
        };
        typedArrayMap[DBOMarkers_Float32] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length * Binary::ByteCounts_Float32; i += Binary::ByteCounts_Float32)
            {
                array->push_back(builder->view->getFloat32(i));
            }
            builder->increment(Binary::ByteCounts_Float32 * length);
            return node;
        };
        ...
        typedArrayMap[DBOMarkers_Int64] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length * Binary::ByteCounts_Int64; i += Binary::ByteCounts_Int64)
            {
                array->push_back(builder->view->getFloat64(i));
            }
            builder->increment(Binary::ByteCounts_Int64 * length);
            return node;
        };
        typedArrayMap[DBOMarkers_UInt64] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length * Binary::ByteCounts_UInt64; i += Binary::ByteCounts_UInt64)
            {
                array->push_back(builder->view->getFloat64(i));
            }
            builder->increment(Binary::ByteCounts_UInt64 * length);
            return node;
        };
        typedArrayMap[DBOMarkers_Float64] = [](DBOBuilder *builder, uint32_t length) -> DBONode *
        {
            ...
            for (int i = builder->index(); i < builder->index() + length * Binary::ByteCounts_Float64; i += Binary::ByteCounts_Float64)
            {
                array->push_back(builder->view->getFloat64(i));
            }
            builder->increment(Binary::ByteCounts_Float64 * length);
            return node;
        };
        ...
        makrerMap[DBOMarkers_Name] = [](DBOBuilder *builder) -> void
        {
            ...
            builder->increment(length * Binary::ByteCounts_UInt16);
        };
        ...
        makrerMap[DBOMarkers_Int8] = [](DBOBuilder *builder) -> void
        {
            ...
            builder->assign(node);
            builder->increment(Binary::ByteCounts_Int8);
        };
        ...
        makrerMap[DBOMarkers_Float32] = [](DBOBuilder *builder) -> void
        {
            ...
            builder->assign(node);
            builder->increment(Binary::ByteCounts_Float32);
        };
        ...
        makrerMap[DBOMarkers_UInt64] = [](DBOBuilder *builder) -> void
        {
            ...
            builder->assign(node);
            builder->increment(Binary::ByteCounts_Float64);
        };
        ...
        makrerMap[DBOMarkers_TypedArray] = [](DBOBuilder *builder) -> void
        {
            ...
            auto length = builder->view->getUint32(builder->index() + Binary::ByteCounts_UInt8);
            builder->increment(Binary::ByteCounts_UInt32 + Binary::ByteCounts_UInt8);
