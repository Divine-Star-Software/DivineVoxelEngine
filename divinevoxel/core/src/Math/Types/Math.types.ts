...
export type Position2Matrix = { x: number; y: number };
export type Dimension2Matrix = { width: number; height: number };
export type Dimension3Matrix = { width: number; height: number; depth: number };
export type DimensionsVector3 = { w: number; h: number; d: number };
