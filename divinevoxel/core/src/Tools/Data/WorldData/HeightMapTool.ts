//types
import type { ChunkData, Column } from "Types/Data/WorldData.types";
...
export class HeightMapTool extends LocationBoundTool {
 ...
 chunk = {
  ...
  hasVoxels() {
   HeightMapTool._chunkTool._c = this._c;
   return (
    HeightMapTool._chunkTool.getArrayTagValue(ChunkTagIDs.heightMap, this._y) ==
    1
   );
  },
  isDirty() {
   HeightMapTool._chunkTool._c = this._c;
   return (
    HeightMapTool._chunkTool.getArrayTagValue(ChunkTagIDs.dirtyMap, this._y) ==
    1
   );
  },
