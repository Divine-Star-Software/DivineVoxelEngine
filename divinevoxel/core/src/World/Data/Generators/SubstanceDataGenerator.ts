import type { SubstanceData } from "Types/Data/Substances/Substances.types.js";
...
export const SubstanceDataGenerator = {
  $generate() {
    ...
    //create data buffer
    const initData = SubstanceTagBuilder.build(
      DVEW.dataRegister.substances.data.size
    );
