...
//data
import { StairStates } from "@divinevoxel/core/Data/Shapes/StairStates.js";
...
export const StairVoxelShape = {
 ...
 add: {
  top() {
   ShapeBuilder.build(
    StairBuilderData[ShapeTool.data.voxel.getShapeState()][FaceRecord["top"]]
   );
  },
  bottom() {
   ShapeBuilder.build(
    StairBuilderData[ShapeTool.data.voxel.getShapeState()][FaceRecord["bottom"]]
   );
  },

  north() {
   ShapeBuilder.build(
    StairBuilderData[ShapeTool.data.voxel.getShapeState()][FaceRecord["north"]]
   );
  },
  south() {
   ShapeBuilder.build(
    StairBuilderData[ShapeTool.data.voxel.getShapeState()][FaceRecord["south"]]
   );
  },
  east() {
   ShapeBuilder.build(
    StairBuilderData[ShapeTool.data.voxel.getShapeState()][FaceRecord["east"]]
   );
  },
  west() {
   ShapeBuilder.build(
    StairBuilderData[ShapeTool.data.voxel.getShapeState()][FaceRecord["west"]]
   );
  },
 },
};
...
const halfHeightQuad = (
 ...
 const fullQuads: Record<DirectionNames, QuadData> = {
