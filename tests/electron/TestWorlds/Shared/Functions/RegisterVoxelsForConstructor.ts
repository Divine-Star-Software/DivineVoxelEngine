...
export function RegisterVoxelsForConstructor(
 ...
 voxels.push(
  //util
  DebugBoxVoxelBuilderThread,
  LightDebugBoxVoxelBuilderThread,
  DataHolderVoxelBuilderThread,
  MarkerBoxVoxelBuilderThread,
  //dream
  DreamGrassBlockVoxelBuilderThread,
  DreamStonePillarVoxelBuilderThread,
  DreamStoneVoxelBuilderThread,
  DreamLampVoxelBuilderThread,
  DreamStoneSlabVoxelBuilderThread,
  DreamLogVoxelBuilderThread,
  DreamStoneStairVoxelBuilderThread,
  DreamGrassVoxelBuilderThread,
  DreamVineVoxelBuilderThread,
  DreamLeafVoxelBuilderThread,
  LiquidDreamEtherVoxelBuilderThread,
  //dread
  DreadStoneVoxelBuilderThread,
  DreadGrassBlockVoxelBuilderThread,
  DreadGrassVoxelBuilderThread,
  DreadLampVoxelBuilderThread,
  DreadStonePillarVoxelBuilderThread,
  LiquidDreadEtherVoxelBuilderThread
 );
