    ...
    if (request.method == "POST") {
        ...
        request.on("end", function () {
            return __awaiter(this, void 0, void 0, function () {
                var message, regionString, jsonString, pipeCount, finalCount, i, char, json, regionString;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(messageType_1 == "json")) return [3 /*break*/, 2];
                            message = JSON.parse(body_1);
                            console.log(message);
                            if (!(message.type == "load-region")) return [3 /*break*/, 2];
                            response.writeHead(200, { "Content-Type": "application/arraybuffer" });
                            return [4 /*yield*/, fs.readFile("./data/".concat(getRegionName(message.location)), {
                                    encoding: "utf8",
                                })];
                        case 1:
                            ...
                            _a.label = 2;
                        case 2:
                            if (!(messageType_1 == "dve")) return [3 /*break*/, 4];
                            jsonString = "";
                            pipeCount = 0;
                            finalCount = 0;
                            for (i = 0; i < body_1.length; i++) {
                                char = body_1[i];
                                finalCount++;
                                if (char == "|") {
                                    pipeCount++;
