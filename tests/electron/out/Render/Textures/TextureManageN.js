...
export const TextureManagerNew = {
    defaultTexturePath: "",
...
TextureManagerNew.addTextureType("#dve_solid");
TextureManagerNew.addTextureType("#dve_flora");
TextureManagerNew.addTextureType("#dve_liquid");
