...
export declare const TextureCreator: {
    ...
    createMaterialTexture(name: string, images: string[], width?: number, height?: number): Promise<BABYLON.RawTexture2DArray[]>;
    _createTextures(name: string, images: string[], width: number, height: number): Promise<BABYLON.RawTexture2DArray>;
