...
export const DataManager = {
    ...
    async loadRegion(x, y, z) {
        ...
        while (currentIndex < rawRegion.length) {
            ...
            currentIndex = SABData.newIndex;
            DVEFX.worldComm.sendMessage("set-chunk", [
                chunkPOS.x,
                chunkPOS.y,
                chunkPOS.z,
                voxelSAB,
    ...
    saveRegion(x, y, z) {
        ...
        const region = DVEFX.worldMatrix.getRegion(x, y, z);
        if (!region) {
        ...
        regionArray[1] = DVEFX.worldBounds.chunkTotalVoxels;
        regionArray[2] = DVEFX.worldBounds.chunkArea * 2;
        regionArray[3] = 2;
        let currentIndex = 3;
    ...
    _getRegionBufferSize(totalChunks) {
        ...
        //voxels
        returnValue += totalChunks * DVEFX.worldBounds.chunkTotalVoxels;
        //voxel states
        returnValue += totalChunks * DVEFX.worldBounds.chunkTotalVoxels;
        //height map
        returnValue += totalChunks * DVEFX.worldBounds.chunkArea * 2;
        //min max map
