...
export declare const RichData: {
    ...
    getRichRegion(x: number, y: number, z: number): false | RichWorldRegion;
    getRichChunk(x: number, y: number, z: number): false | RichChunk;
    addRichRegion(x: number, y: number, z: number): false | RichWorldRegion;
    addRichChunk(x: number, y: number, z: number): RichChunk;
    setRichData(x: number, y: number, z: number, data: any): void;
    getRichData<T>(x: number, y: number, z: number): false | T;
};
