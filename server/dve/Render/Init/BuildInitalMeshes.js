export async function BuildInitalMeshes(DVER, scene) {
    ...
    DVER.renderManager.solidMaterial.createMaterial(DVER.settings.settings, scene, combinedChunkTextures, solidAnimations, soidAnimationTimes);
    ...
    DVER.renderManager.fluidMaterial.createMaterial(DVER.settings.settings, scene, combinedFluidTextures, fluidAnimations, fluidAnimationTimes);
