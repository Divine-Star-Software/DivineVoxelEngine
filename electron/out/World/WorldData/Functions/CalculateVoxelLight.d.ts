...
export declare function CalculateVoxelLight(this: WorldData, voxel: VoxelInteface, voxelData: any[], voxelPalette: VoxelPalette, RGBlightTemplate: number[], sunlightTemplate: number[], exposedFaces: number[], chunkX: number, chunkY: number, chunkZ: number, x: number, y: number, z: number): void;
