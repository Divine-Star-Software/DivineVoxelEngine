//types
import type { DivineVoxelEngineBuilder } from "../../../out/Builder/DivineVoxelEngineBuilder.js"; //voxels
//voxels
...
export function RegisterVoxelsForBuilderThread(DVEB: DivineVoxelEngineBuilder) {
 //solid
