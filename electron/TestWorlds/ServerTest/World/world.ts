...
const sharedBufferToBuffer = (sab: SharedArrayBuffer) => {
 const temp1 = new Uint8Array(sab);
...
const playerSABS: Record<number, SharedArrayBuffer> = {};
...
(self as any).addVoxel = (
 ...
 const rawVoxelData = DVEW.worldData.getRawVoxelData(
  voxelId,
  voxelState,
  shapeState
 );
