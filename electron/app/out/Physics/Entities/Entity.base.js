                ...
                for (let zi = minZi; zi <= maxZi; zi++) {
                    for (let xi = minXi; xi <= maxXi; xi++) {
                        ...
                        for (let i = 0; i < collidersLength; i++) {
                            ...
                            const c = DVEPH.collisions.sweepAABB(this.px - this.hx / 2, this.py - this.hy / 2, this.pz - this.hz / 2, this.hx, this.hy, this.hz, collider.position[0], collider.position[1], collider.position[2], collider.boundingBox.w, collider.boundingBox.h, collider.boundingBox.d, dx, dy, dz);
                            if (c.ny == 1) {
                                this.onGround = true;
                            }
                            if (c.h < 1) {
