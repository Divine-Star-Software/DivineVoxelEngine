...
export declare function VoxelSunLightMixCalc(this: WorldData, voxelData: any[], voxel: VoxelInteface, voxelPalette: VoxelPalette, chunkX: number, chunkY: number, chunkZ: number, voxelX: number, voxelY: number, voxelZ: number, checkSet: number[]): number;
