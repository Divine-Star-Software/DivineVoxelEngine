...
export declare function VoxelLightMixCalc(this: WorldData, voxelLigtValue: number, voxel: VoxelInteface, chunkX: number, chunkY: number, chunkZ: number, voxelX: number, voxelY: number, voxelZ: number, checkSet: number[]): any;
