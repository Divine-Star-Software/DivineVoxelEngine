...
export declare const ChunkProcessor: {
    heightByte: {
        heightMapArray: {
            ...
            getValue(x: number, y: number, z: number, array: import("Meta/Chunks/Chunk.types.js").ChunkVoxels): number;
            getValueUseObj(position: import("../../../Meta/Util.types.js").Position3Matrix, array: import("Meta/Chunks/Chunk.types.js").ChunkVoxels): number;
            getValueUseObjSafe(position: import("../../../Meta/Util.types.js").Position3Matrix, array: import("Meta/Chunks/Chunk.types.js").ChunkVoxels): any;
            setValue(x: number, y: number, z: number, array: import("Meta/Chunks/Chunk.types.js").ChunkVoxels, value: number): void;
            setValueUseObj(position: import("../../../Meta/Util.types.js").Position3Matrix, array: import("Meta/Chunks/Chunk.types.js").ChunkVoxels, value: number): void;
            setValueUseObjSafe(position: import("../../../Meta/Util.types.js").Position3Matrix, array: import("Meta/Chunks/Chunk.types.js").ChunkVoxels, value: number): void;
            deleteValue(x: number, y: number, z: number, array: import("Meta/Chunks/Chunk.types.js").ChunkVoxels): void;
            deleteUseObj(position: import("../../../Meta/Util.types.js").Position3Matrix, array: import("Meta/Chunks/Chunk.types.js").ChunkVoxels): void;
