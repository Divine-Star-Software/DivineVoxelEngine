...
This test world is just for testing light issues. It makes use of the light debug voxel. 
`;
console.log("%clight debug test", "font-family: Consolas,monaco,monospace; color:cyan; font-size:30px;");
console.log(`%c ${testDescription}`, "font-family: Consolas,monaco,monospace; color:green; font-size:20px;");
...
const init = async () => {
    ...
    axes.xAxis.position.y = 10;
    axes.yAxis.position.y = 10;
    axes.zAxis.position.y = 10;
