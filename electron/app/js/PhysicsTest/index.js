...
const checkPointTest = (scene) => {
    const simpleBoundingBox = DVEM.getSimpleBoundingBox(DVEM.getPositionVector3(0, 6.5, 0), { w: 0.8, h: 2, d: 0.8 });
    const playerHitBox = BABYLON.MeshBuilder.CreateBox("player-hitbox", { width: 0.8, height: 2, depth: 0.8 }, scene);
    const voxelCheckBox = BABYLON.MeshBuilder.CreateBox("player-hitbox", { width: 1, height: 1, depth: 1 }, scene);
    const origionBox = BABYLON.MeshBuilder.CreateBox("player-hitbox", { width: 1, height: 1, depth: 1 }, scene);
    const origionVoxelBox = BABYLON.MeshBuilder.CreateBox("player-hitbox", { width: 1, height: 1, depth: 1 }, scene);
    const checkBox = BABYLON.MeshBuilder.CreateBox("checkbox", { width: 1, height: 1, depth: 1 }, scene);
    ...
    const origionBoxes = [];
    const origionCheckBoxes = [];
    const checkBoxes = [];
    const checkBoxesVxels = [];
    ...
    simpleBoundingBox.setCheckOrigion(boxOrogion.x + 10, boxOrogion.y, boxOrogion.z);
    ...
    setInterval(() => {
        ...
        simpleBoundingBox.updateOrigion(boxOrogion.x - 0.01, boxOrogion.y, boxOrogion.z - 0.01);
        ...
        simpleBoundingBox.setCheckOrigion(boxOrogion.x - 0.02, boxOrogion.y, boxOrogion.z - 0.02);
