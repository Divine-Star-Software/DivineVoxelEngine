...
export const WorldGen = {
    ...
    generateTree(x, y, z) {
        ...
        DVEW.worldData.paintVoxel("dve:dream-leafs", "default", 0, x - 1, y + 4, z);
        DVEW.worldData.paintVoxel("dve:dream-leafs", "default", 0, x + 1, y + 4, z + 1);
        DVEW.worldData.paintVoxel("dve:dream-leafs", "default", 0, x + 1, y + 4, z - 1);
        DVEW.worldData.paintVoxel("dve:dream-leafs", "default", 0, x + 1, y + 4, z + 1);
        DVEW.worldData.paintVoxel("dve:dream-leafs", "default", 0, x + 1, y + 4, z - 1);
        DVEW.worldData.paintVoxel("dve:dream-leafs", "default", 0, x - 1, y + 4, z + 1);
                ...
                for (let y = 0; y < this.chunkHeight; y++) {
                    ...
                    if (y >= baseY - 2 && y < baseY + 1) {
                        if (y == baseY - 2 && Math.random() > 0.8) {
                            DVEW.worldData.paintDualVoxel("dve:liquiddreamether", "default", 0, "dve:dreamgrass", "default", x, y, z);
                        }
                        else {
