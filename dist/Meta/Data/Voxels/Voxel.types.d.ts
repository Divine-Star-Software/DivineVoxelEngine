 ...
 */
export type VoxelSubstanceType = "#dve_solid" | "#dve_transparent" | "#dve_flora" | "#dve_liquid" | "#dve_magma" | string;
 ...
 */
export type VoxelTemplateSubstanceType = "#dve_solid" | "#dve_flora" | "#dve_liquid" | "#dve_magma" | string;
/**# Voxel Data
 * ---
