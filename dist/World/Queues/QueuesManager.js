...
export const QueuesManager = {
    ...
    runRGBUpdateQue() {
        ...
        while (queue.length != 0) {
            ...
            DVEW.worldGenCommManager.runRGBFloodFillAt(position[0], position[1], position[2]);
        }
    ...
    runRGBRemoveQue() {
        ...
        while (queue.length != 0) {
            ...
            if (!position)
                break;
            DVEW.worldGenCommManager.runRGBFloodRemoveAt(position[0], position[1], position[2]);
        }
