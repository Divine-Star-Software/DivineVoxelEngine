...
export declare const VoxelMath: {
    visitAll: (startPoint: import("./Types/Math.types.js").Position3Matrix, endPoint: import("./Types/Math.types.js").Position3Matrix, visitor?: (x: number, y: number, z: number) => boolean) => number[];
