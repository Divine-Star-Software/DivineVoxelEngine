export async function BuildInitalMeshes(DVE, scene) {
    ...
    const floraAnimationTimes = DVE.worldComm.baseWorldData.textureAnimationTimes.flora;
    ...
    const fluidAnimationTimes = DVE.worldComm.baseWorldData.textureAnimationTimes.fluid;
    ...
    const magmaAnimationTimes = DVE.worldComm.baseWorldData.textureAnimationTimes.magma;
