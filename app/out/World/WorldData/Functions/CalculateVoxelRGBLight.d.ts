...
export declare function VoxelRGBLightMixCalc(this: WorldData, airData: any[], voxel: VoxelInteface, voxelPallet: VoxelPallet, chunkX: number, chunkY: number, chunkZ: number, voxelX: number, voxelY: number, voxelZ: number, checkSet: number[]): number;
