...
export declare function ChunkOcculsionCalcuation(worldData: WorldData, chunk: number[][][], chunkX: number, chunkZ: number, blockX: number, blockY: number, blockZ: number, x: number, y: number, z: number): 1 | 0.75;
