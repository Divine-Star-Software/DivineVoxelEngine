import type { TagBuilderNodes } from "Data/Types/StructBuilder.types.js";
import {
  BinaryStructData,
  BinraryStructBase,
  BinaryNumberTypes,
...
export class StructBuilder {
  ...
  getMaps(): DataSyncMapsData {
    const objectMaps: Record<string, any[]> = {};
    const stringMaps: Record<string, string[]> = {};
