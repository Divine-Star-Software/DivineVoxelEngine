...
export const StandardSolidMaterial = {
 ...
 plugin: <SolidMaterialPlugin | null>null,

 $INIT(texture: BABYLON.RawTexture2DArray, scnee: BABYLON.Scene) {
  ...
  const bump = new BABYLON.Texture(
   "assets/textures/normalmaps/dreamstone/default.png",
   scnee
  );
