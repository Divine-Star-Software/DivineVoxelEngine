...
`;
 ...
 buildFragmentShader(fragMain: string, doAO = true, vars = "") {
  return `
 ...
 getDefaultVertexShader(
  voxelSubstance: VoxelTemplateSubstanceType | "Item",
  data: VertexShaderCreateData
 ) {
  if (voxelSubstance == "magma") {
   return this.buildVertexShader(
    data,
    VoxelShaders.liquid.vertexWave,
    false,
    VoxelShaders.liquid.vertexVars
   );
  }
 ...
 getDefaultFragmentShader(voxelSubstance: VoxelTemplateSubstanceType | "Item") {
  if (voxelSubstance == "solid") {
   return this.buildFragmentShader(VoxelShaders.solid.fragMain);
  }
  if (voxelSubstance == "magma") {
   return this.buildFragmentShader(
    VoxelShaders.liquid.fragMain,
    false,
    VoxelShaders.liquid.fragVars
   );
  }
  if (voxelSubstance == "liquid") {
   return this.buildFragmentShader(
