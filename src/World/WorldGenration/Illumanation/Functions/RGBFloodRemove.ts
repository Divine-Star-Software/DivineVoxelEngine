...
export function RGBFloodRemoveCheckNeighors(
...
export function RGBFloodRemoveUpdateAirLightVoxel(
 this: IlluminationManager,
 airBlock: any[],
 x: number,
 y: number,
 ...
 this.air[this.air.length - 1] = this.lightByte.calculateRGBUpdateLight(
  l1,
  n1,
  n2,
  n3,
...
export function RGBFloodRemoveSetAirLightVoxel(
 this: IlluminationManager,
 x: number,
 y: number,
 z: number
 ...
 this.air[this.air.length - 1] = this.lightByte.calculateRGBSetLight(
  n1,
  n2,
  n3,
  n4,
