...
export function RGBFloodFillCheckNeighbors(
...
export function RGBFloodFillUpdateAirLightVoxel(
 this: IlluminationManager,
 airBlock: any[],
 x: number,
 y: number,
...
export function RGBFloodFillSetAirLightVoxels(
 this: IlluminationManager,
 x: number,
 y: number,
 z: number
