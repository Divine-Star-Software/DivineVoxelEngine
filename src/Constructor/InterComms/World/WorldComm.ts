...
worldComm.messageFunctions[WorldToConstructorMessages.runFlow] = async (
 data
) => {
 const x = data[1];
 const y = data[2];
...
worldComm.messageFunctions[WorldToConstructorMessages.constructEntity] = (
 data
) => {
 const x = data[1];
 const y = data[2];
...
worldComm.messageFunctions[WorldToConstructorMessages.constructItem] = (
 data
) => {
 const itemId = data[1];
 const x = data[2];
