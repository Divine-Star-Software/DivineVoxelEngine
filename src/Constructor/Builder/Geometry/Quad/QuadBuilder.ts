...
const defaultTransform: QuadTransforms = {
 1: { x: 0, y: 0, z: 0 },
 2: { x: 0, y: 0, z: 0 },
 3: { x: 0, y: 0, z: 0 },
 4: { x: 0, y: 0, z: 0 },
};
const qDimensinos: QuadDimensions = {
 width: 0,
 height: 0,
};
 ...
 >{
  top: (origin, data, transform, flip) => {
   if (!flip) {
    data.positions.push(
     //v1
     origin.x - qDimensinos.width + transform[1].x,
     origin.y + transform[1].y,
     origin.z - qDimensinos.height + transform[1].z,
     //v2
     origin.x - qDimensinos.width + transform[2].x,
     origin.y + transform[2].y,
     origin.z + qDimensinos.height + transform[2].z,
     //v3
     origin.x + qDimensinos.width + transform[3].x,
     origin.y + transform[3].y,
     origin.z + qDimensinos.height + transform[3].z,
     //v4
     origin.x + qDimensinos.width + transform[4].x,
     origin.y + transform[4].y,
     origin.z - qDimensinos.height + transform[4].z
    );
   } else {
    data.positions.push(
     //v1
  ...
  south: (origin, data, transform, flip) => {
   if (!flip) {
    data.positions.push(
     //v1
     origin.x - qDimensinos.width + transform[1].x,
     origin.y + qDimensinos.height + transform[1].y,
     origin.z + transform[1].z,
     //v2
     origin.x + qDimensinos.width + transform[2].x,
     origin.y + qDimensinos.height + transform[2].y,
     origin.z + transform[2].z,
     //v3
     origin.x + qDimensinos.width + transform[3].x,
     origin.y - qDimensinos.height + transform[3].y,
     origin.z + transform[3].z,
     //v4
     origin.x - qDimensinos.width + transform[4].x,
     origin.y - qDimensinos.height + transform[4].y,
  ...
  west: (origin, data, transform, flip) => {
   if (!flip) {
    data.positions.push(
     ...
     origin.y + qDimensinos.height + transform[1].y,
     origin.z + qDimensinos.width + transform[1].z,
     //v2
     origin.x + transform[2].x,
     origin.y + qDimensinos.height + transform[2].y,
     origin.z - qDimensinos.width + transform[2].z,
     //v3
     origin.x + transform[3].x,
     origin.y - qDimensinos.height + transform[3].y,
     origin.z - qDimensinos.width + +transform[3].z,
     //v4
     origin.x + transform[4].x,
     origin.y - qDimensinos.height + transform[4].y,
     origin.z + qDimensinos.width + transform[4].z
    );
   } else {
    data.positions.push(
     //v1
